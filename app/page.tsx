...
//         Gestione sus servicios, consulte sus facturas y realice reclamos de
...
//                 className='w-16 h-16 mx-auto mb-4 text-[#2e7d32]'
//               />
//               <h3 className='text-xl font-semibold mb-2'>Solicitar Conexión</h3>
//               <p className='text-gray-600'>
...
// const Home = () => {
//   // Logic for the animated counter
//   const [connectionCount, setConnectionCount] = useState(0);
//   const targetCount = 2500;

//   useEffect(() => {
//     if (connectionCount < targetCount) {
//       const timer = setTimeout(() => {
//         setConnectionCount(Math.min(connectionCount + 150, targetCount));
//       }, 10);
...
type NavbarProps = {
  user: Partial<User> & { id: number; role: "socio" | "admin" | "tecnico" | "superadmin"; status: "activo" | "moroso" | "suspendido" | "baja"; } | null;
};
