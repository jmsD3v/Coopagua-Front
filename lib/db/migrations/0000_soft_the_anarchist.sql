-- This migration file is from an older version of the schema.
-- The tables 'teams', 'team_members', and 'invitations' are no longer in use.
-- They are commented out to prevent errors during migration.

CREATE TABLE IF NOT EXISTS "activity_logs" (
	"id" serial PRIMARY KEY NOT NULL,
	-- "team_id" integer NOT NULL, -- Obsolete column
	"user_id" integer,
