...
export const readings = pgTable('readings', {
  id: serial('id').primaryKey(),
  meterId: integer('meter_id').notNull().references(() => meters.id),
...
export const metersRelations = relations(meters, ({ one, many }) => ({
  address: one(addresses, { fields: [meters.addressId], references: [addresses.id] }),
...
export const invoicesRelations = relations(invoices, ({ one, many }) => ({
  ...
  reading: one(readings, { fields: [invoices.readingId], references: [readings.id] }),
...
export const claimsRelations = relations(claims, ({ one }) => ({
  ...
  address: one(addresses, { fields: [claims.addressId], references: [addresses.id] }),
