...
import { NewUser, userRoleEnum, connectionStatusEnum, User } from '@/lib/db/schema';
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-bold leading-6">Edit User</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Update the details for {user.name || user.email}.
          </p>
        </div>
      </div>
